                        ...
                        <div class="service-details__left">
                            <div class="service-details__service-box">
                                <ul class="service-details__services-list list-unstyled">
                                    <li>
                                        <a href="evolve-space-designs.html">Evolve Space Designs<span
                                                class="icon-right"></span></a>
                                    </li>
                                    <li class="active">
                                        <a href="eden-home-styling.html">Eden Home Styling<span
                                                class="icon-right"></span></a>
                                    </li>
                                    <li>
                                        <a href="harmony-interiors.html">Harmony Interiors<span
                                                class="icon-right"></span></a>
                                    </li>
                                    <li>
                                        <a href="interior-design.html">Interior Design<span
                                                class="icon-right"></span></a>
                                    </li>
                                    <li>
                                        <a href="urban-design.html">Urban Design<span class="icon-right"></span></a>
                                    </li>
                                    <li>
                                        <a href="landscape-design.html">Landscape Design<span
                                                class="icon-right"></span></a>
                                    </li>
                                </ul>
                            </div>
