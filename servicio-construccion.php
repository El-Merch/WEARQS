            ...
            <div class="container">
                <div class="page-header__inner">
                    <div class="page-header__title-box">
                        <p>Transformamos ideas en espacios reales</p>
                        <h3>Nuestros Sevicios</h3>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="service-details__left">
                            ...
                            <div class="service-details__contact-box">
                                <h3 class="service-details__title">Contáctanos para cualquier consejo.</h3>
                                <div class="service-details__icon">
                                    <span class="icon-telephone"></span>
                                </div>
                                <p class="service-details__text">¿Necesitas ayuda? Habla con un experto.</p>
                                <p class="service-details__number"><a href="tel:998-332-2672">998-332-2672</a></p>
                            </div>
